...
#' @description Implementation of the Keetch Byram Drought Index for vector data
...
#' @return A numeric vector containing the (daily) KBDI time series series
#' @details The physical theory for the Keetch-Byram Drought Index {Keetch:1968} is based on a number of assumptions: 
...
kbdindex <- function(dates, t, p, wrs = 5, start.date = NULL) { # requires date to compute mean annual precipitation
